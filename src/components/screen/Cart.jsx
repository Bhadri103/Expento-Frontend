        ...
        <div>
            ...
            {cartItems.length > 0 ? (
                <>
                    ...
                    <div className="d-flex mt-3 mb-5 align-items-center w-100 justify-content-between p-3"
                        style={{ boxShadow: "0.3px 0.3px 10px rgba(123, 123, 123, 0.4)" }}>
                        <img src={deliveryPartner} alt="Delivery Partner" className="me-3"
                ...
                <div className="d-flex flex-column align-items-center justify-content-center h-100 my-5">
                    <h4 className="text-center fw-regular">Your cart is empty.</h4>
                    <button  style={{borderRadius: "8px", border:"1px solid #082A45", color: "#082A45", padding: "8px 20px"}} className="b mt-3" onClick={() => navigate('/')}>
                        Browse Products
                    </button>
                </div>
            )}
